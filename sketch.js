...
function setup() {
  ...
  //Second level
  block8=new Box(330+60,235,30,40);
  block9=new Box(360+60,235,30,40);
  block10=new Box(390+60,235,30,40);
  block11=new Box(420+60,235,30,40);
  block12=new Box(450+60,235,30,40);

  //Third level
  block13=new Box(360+60,195,30,40);
  block14=new Box(390+60,195,30,40);
  block15=new Box(420+60,195,30,40);
  
  //Fouth level
  block16=new Box(390+60,155,30,40);
  ...
  //Middle level 
  block22=new Box(800-30,205-40,30,40);
  block23=new Box(800,205-40,30,40);
  block24=new Box(800+30,205-40,30,40);
...
function keyPressed()
{
  if(keyCode===32)
  {
    Body.setPosition(pentagon.body,{x:100,y:200});
